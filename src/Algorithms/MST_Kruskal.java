...
public class MST_Kruskal {
    public static void main(String[] args) {
        ArrayList<Edge> graphEdges = new ArrayList<>();		//edge list, not adjacency list
        ...
        MST_Kruskal graph = new MST_Kruskal();	//CAREFUL: nodeCount must be correct. No error checking between nodeCount & graphEdges to see how many nodes actually exist
